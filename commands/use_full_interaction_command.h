...
#ifndef COMMANDS_USE_FULL_INTERACTION_COMMAND_H_
#define COMMANDS_USE_FULL_INTERACTION_COMMAND_H_
...
public:
	...
	void execute() const;
    Command* clone() { return new UseFullInteractionCommand(m_group_vec, m_trigger_group, m_on_enter_proc_id_self, m_on_exit_proc_id_self, m_on_enter_proc_id_other); }
...
#endif /* COMMANDS_USE_FULL_INTERACTION_COMMAND_H_ */
