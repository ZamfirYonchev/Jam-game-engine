    	...
    	if(movement.gravity_affected())
			...
			switch(m_current_state)
			{
				...
				case RenderStates::IDLE:
					...
					else if(control.decision_walk() != 0) set_new_state(RenderStates::WALK);
					else if(control.decision_vertical() > 0) set_new_state(RenderStates::JUMP);
					else if(control.decision_vertical() < 0) set_new_state(RenderStates::FALL);
					else advance_animation(time_diff);
				break;
				...
				case RenderStates::WALK:
					...
					else set_new_state(RenderStates::IDLE);
				break;
				...
				case RenderStates::ATTACK:
					...
					else if(m_last_frame && (control.decision_walk() != 0)) set_new_state(RenderStates::WALK);
					else if(m_last_frame && (control.decision_vertical() > 0)) set_new_state(RenderStates::JUMP);
					else if(m_last_frame && (control.decision_vertical() < 0)) set_new_state(RenderStates::FALL);
					else if(m_last_frame) set_new_state(RenderStates::IDLE);
					else advance_animation(time_diff);
				break;
